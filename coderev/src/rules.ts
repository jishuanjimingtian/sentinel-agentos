import { ReviewRule, ReviewResult, ReviewContext } from './types.js';

// ── 安全性规则 ──
const hardcodedSecrets: ReviewRule = {
  name: 'hardcoded-secrets',
  severity: 'error',
  check(line: string, lineNumber: number): ReviewResult | null {
    const patterns = [
...
const trailingWhitespace: ReviewRule = {
...
// ── TypeScript 安全 ──
const anyType: ReviewRule = {
  name: 'no-explicit-any',
  severity: 'warning',
  check(line: string, lineNumber: number, ctx: ReviewContext): ReviewResult | null {
...
const hooksConditional: ReviewRule = {
...
const useStateSetter: ReviewRule = {
...
// ── 性能反模式 ──
const arraySpreadInRender: ReviewRule = {
...
const largeArrayLiteral: ReviewRule = {
...
const unvalidatedRedirect: ReviewRule = {
...
const insecureProtocol: ReviewRule = {
...
const looseComparison: ReviewRule = {
